        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 leading-tight mb-6">
              Exceptional Senior Living at <span className="text-green-600">Silver Springs</span>
            </h1>

            <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed">
              Experience compassionate care, vibrant community living, and peace of mind in our beautiful assisted
              living residences. Your comfort and well-being are our top priorities.
            </p>
            ...
            <div className="mt-8 pt-8 border-t border-gray-200">
              <div className="grid grid-cols-3 gap-4 text-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">Activities Monthly</div>
                </div>
                <div>
            ...
            <div className="relative rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-4 left-4 right-4 bg-white/95 backdrop-blur-sm rounded-lg p-4 shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-semibold text-gray-900">Silver Springs Residency</h3>
                    <p className="text-sm text-gray-600">Luxury Senior Living Community</p>
                  </div>

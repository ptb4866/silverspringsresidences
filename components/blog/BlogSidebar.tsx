...
export default function BlogSidebar() {
  ...
  const recentPosts = [
    { title: "Understanding the Different Levels of Senior Care", slug: "understanding-senior-care-levels" },
    { title: "Creating a Smooth Transition to Assisted Living", slug: "smooth-transition-to-assisted-living" },
    { title: "Nutrition Tips for Seniors: Eating Well as You Age", slug: "senior-nutrition-tips" },
    { title: "Staying Active: Exercise Options for Seniors", slug: "senior-exercise-options" }
  ]

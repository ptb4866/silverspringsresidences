      ...
      <div className="space-y-8">
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4 mb-6">
            <div className="flex items-start">
              <MapPin size={20} className="mr-3 text-green-600 mt-1 flex-shrink-0" />
            ...
            <div className="flex items-center">
              ...
              <a href="tel:+15551234567" className="text-gray-700 hover:text-green-700 transition-colors">
                (555) 123-4567
              </a>
            </div>
            ...
            <div className="flex items-center">
              ...
              <a href="mailto:maple@silversprings.com" className="text-gray-700 hover:text-green-700 transition-colors">
                maple@silversprings.com
              </a>
            </div>
            
            <div className="flex items-start">
              <Clock size={20} className="mr-3 text-green-600 mt-1 flex-shrink-0" />
              <div>
                <p className="text-gray-700">
                  <span className="font-medium">Tours available:</span><br />
        ...
        <div className="bg-white p-6 rounded-lg shadow-md">
          ...
          <div className="space-y-4 mb-6">
            ...
            <div className="flex items-center">
              <Phone size={20} className="mr-3 text-green-600 flex-shrink-0" />
              <a href="tel:+15557654321" className="text-gray-700 hover:text-green-700 transition-colors">
                (555) 765-4321
              </a>
            </div>
            ...
            <div className="flex items-center">
              <Mail size={20} className="mr-3 text-green-600 flex-shrink-0" />
              <a href="mailto:willow@silversprings.com" className="text-gray-700 hover:text-green-700 transition-colors">

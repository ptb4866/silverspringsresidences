...
const locations = [
  ...
  },
  {
    ...
    amenities: ["Lakefront Views", "Wellness Center", "Library", "Art Studio", "Walking Trails", "24/7 Nursing Care"],
    transportation: {
                ...
                <div className="bg-gray-50 rounded-2xl p-8">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        <p className="text-gray-900">Monday - Friday: {location.hours.weekdays}</p>
                        <p className="text-gray-600">Weekends: {location.hours.weekends}</p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="bg-white border border-gray-200 rounded-2xl p-8">
                  ...
                  <div className="space-y-6">
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        <h4 className="font-semibold text-gray-900 mb-1">Driving</h4>
                        <p className="text-gray-600 text-sm mb-1">{location.transportation.driving}</p>
                        <p className="text-gray-500 text-xs">{location.transportation.parking}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">{location.transportation.publicTransit}</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-4">
                      ...
                      <div>
                        ...
                        <p className="text-gray-600 text-sm">{location.transportation.airport}</p>
                      </div>
                    </div>
                  </div>

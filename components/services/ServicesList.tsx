import { Heart, Clock, Utensils, PillIcon, Shield, Activity } from 'lucide-react'
  ...
  const services = [
    {
      ...
      description: "Customized care plans tailored to each resident's needs, regularly reviewed and updated as needs change."
    },
    {
      icon: <PillIcon className="h-12 w-12 text-green-600" />,
      title: "Medication Management",
      description: "Professional oversight of all medications, including ordering, dispensing, and administration."
    },
    {
      icon: <Utensils className="h-12 w-12 text-green-600" />,
      title: "Nutritious Meals & Snacks",
      description: "Home-cooked meals prepared on-site with attention to dietary needs and preferences."
    },
    {
      icon: <Activity className="h-12 w-12 text-green-600" />,
      title: "Daily Activities",
      description: "Engaging social, physical, and recreational activities designed to enhance quality of life."
    },
    {
      icon: <Clock className="h-12 w-12 text-green-600" />,
      title: "24/7 Care Staff",
      description: "Trained caregivers available around the clock to provide assistance whenever needed."
    },
    {
      icon: <Shield className="h-12 w-12 text-green-600" />,
      title: "Safety & Security",
      description: "Comprehensive safety measures including emergency call systems and monitored entrances."
    }
  ]
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Silver Springs Residency provides comprehensive services to support each resident's 
        ...
        <div className="mt-12 p-6 bg-green-50 rounded-lg border border-green-100">
          <h3 className="text-xl font-bold mb-3 text-gray-800">Additional Services Available:</h3>

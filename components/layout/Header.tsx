...
export default function Header() {
  ...
  const navItems = [
    ...
    { name: "Floor Plans", href: "/floor-plans" },
    {
      ...
      dropdown: [
        { name: "Care Services", href: "/services-and-amenities#care-services" },
        { name: "Community Amenities", href: "/services-and-amenities#amenities" },
      ],
    },
    {
      name: "Contact Us",
          ...
          <div className="flex items-center justify-between h-16 sm:h-20">
            ...
            <Link href="/" className="flex items-center">
              ...
              <div className="text-gray-800">
                <div className="text-base sm:text-lg font-bold leading-tight">Silver Springs</div>
                <div className="text-xs sm:text-sm text-gray-600 uppercase tracking-wider">Residency</div>
              </div>
            </Link>

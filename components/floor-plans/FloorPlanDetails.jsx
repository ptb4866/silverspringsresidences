        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <div className="bg-white p-8 rounded-lg shadow-md h-full">
              ...
              <p className="mt-6 text-gray-600">
                Each private room can be personalized with your own furniture
                and decorations to create a familiar, comfortable space.
              </p>
            </div>
          </div>
          ...
          <div>
            <div className="bg-white p-8 rounded-lg shadow-md h-full">
              ...
              <p className="mt-6 text-gray-600">
                Our shared spaces are designed to foster community while
                ensuring comfort and accessibility for all residents.
              </p>
            </div>
          </div>
        </div>

      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Silver Springs Residency features two beautiful residential homes, each designed 
            to provide comfort, safety, and a warm environment for our residents.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {homes.map((home, index) => (
            <div key={index} className="bg-white rounded-lg overflow-hidden shadow-lg">
              ...
              <div className="p-8">
                <h3 className="text-2xl font-bold mb-4 text-gray-800">{home.name}</h3>
